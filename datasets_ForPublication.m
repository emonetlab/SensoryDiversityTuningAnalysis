...
%     dataparms(1).Files = ["./Data/230417/FOV1.mat"];
    dataparms(1).Files = ["./Data/220106/FOV1.mat", "./Data/230417/FOV1.mat" ];
%     dataparms(1).Files = ["./Data/220106/FOV1.mat", "./Data/230417/FOV1.mat", "./Data/210802/FOV1.mat", "./Data/210805/FOV1.mat"];
    ...
    dataparms(2).Files = ["./Data/210810/FOV1.mat", "./Data/210811/FOV1.mat"];
%     dataparms(2).Files = ["./Data/210811/FOV1.mat"];
    ...
    dataparms(3).Files = ["./Data/210812/FOV1.mat", "./Data/210813/FOV1.mat", "./Data/230705/FOV1.mat"];
%     dataparms(3).Files = ["./Data/230705/FOV1.mat"];
    ...
    dataparms(4).Files = ["./Data/210816/FOV1.mat", "./Data/230717/FOV1.mat", "./Data/230718/FOV1.mat"];
%     dataparms(4).Files = ["./Data/230717/FOV1.mat", "./Data/230718/FOV1.mat"];
    ...
    dataparms(5).Files = ["./Data/210818/FOV1.mat", "./Data/210908/FOV1.mat"]; %Where to load data from
...
%     dataparms(6).Files = ["./Data/210910/FOV1.mat", "./Data/211006/FOV1.mat", "./Data/210913/FOV1.mat", "./Data/220111/FOV1.mat"]; %Where to load data from
...
%     dataparms(6).concLevels = [.005, 0.01, 0.02, 0.05, 0.1; .005, 0.01, 0.02, 0.05, 0.1; .005, 0.01, 0.02, 0.05, 0.1; .005, 0.01, 0.02, 0.05, 0.1];
    dataparms(6).Files = ["./Data/210910/FOV1.mat",  "./Data/210913/FOV1.mat", "./Data/220111/FOV1.mat"]; %Where to load data from
    dataparms(6).OutFolder = '0BackSerDose/'; %Where to output data to
    ...
    dataparms(7).Files = ["./Data/210914/FOV1.mat", "./Data/210916/FOV1.mat"]; %Where to load data from
...
%     dataparms(8).Files = ["./Data/210920/FOV1.mat", "./Data/210921/FOV1.mat"]; %Where to load data from
...
%     dataparms(8).concLevels = [.005, 0.01, 0.02, 0.05, 0.1; .005, 0.01, 0.02, 0.05, 0.1];
    dataparms(8).Files = ["./Data/210921/FOV1.mat"]; %Where to load data from
    dataparms(8).OutFolder = '100MeAspBackSerDose/'; %Where to output data to
    ...
    dataparms(9).Files = ["./Data/211012/FOV1.mat", "./Data/211011/FOV1.mat"]; %Where to load data from
    ...
    dataparms(10).Files = ["./Data/211013/FOV1.mat"]; %Where to load data from
    ...
    dataparms(11).Files = ["./Data/211020/FOV1.mat", "./Data/211021/FOV1.mat"]; %Where to load data from
%     dataparms(11).Files = ["./Data/211020/FOV1.mat"]; %Where to load data from    
...
%     dataparms(11).concLevels = [0.5, 1, 2, 4, 8];
    ...
    dataparms(12).Files = ["./Data/211022/FOV1.mat", "./Data/211025/FOV1.mat"]; %Where to load data from
    ...
    dataparms(13).Files = ["./Data/211026/FOV1.mat", "./Data/211030/FOV2.mat"]; %Where to load data from
...
%     dataparms(14).Files = ["./Data/211027/FOV1.mat"]; %Where to load data from
%     dataparms(14).Files = ["./Data/211028/FOV1.mat", "./Data/211029/FOV1.mat", "./Data/211102/FOV1.mat"]; %Where to load data from
    dataparms(14).Files = ["./Data/211102/FOV1.mat", "./Data/211103/FOV1.mat"]; %Where to load data from  
...
%     dataparms(14).concLevels = [50, 100, 200, 400, 800; 50, 100, 200, 400, 800; 30, 75, 150, 300, 600];
    ...
    dataparms(15).Files = ["./Data/210816/FOV1.mat"];
    ...
    dataparms(16).Files = ["./Data/220302/FOV1.mat", "./Data/220303/FOV1.mat"];
    ...
    dataparms(17).Files = ["./Data/220324/FOV1.mat", "./Data/230511/FOV1.mat"];
    ...
    dataparms(18).Files = ["./Data/220426/FOV1.mat"];
    ...
    dataparms(19).Files = ["./Data/220428/FOV1.mat"]; %Where to load data from
    ...
    dataparms(20).Files = ["./Data/220615/FOV1.mat", "./Data/230410/FOV1.mat"]; %Where to load data from
%     dataparms(20).Files = ["./Data/220615/FOV1.mat"]; %Where to load data from
    ...
    dataparms(21).Files = ["./Data/230330/FOV1.mat", "./Data/230403/FOV1.mat"]; %Where to load data from
...
%     dataparms(22).Files = ["./Data/230404/FOV1.mat"]; %Where to load data from
%     dataparms(22).Files = ["./Data/230404/FOV1.mat", "./Data/230413/FOV1.mat", "./Data/230414/FOV1.mat"]; %Where to load data from
    dataparms(22).Files = ["./Data/230830/FOV1.mat", "./Data/230830/FOV2.mat", "./Data/230831/FOV1.mat", "./Data/230831/FOV2.mat"]; %Where to load data from
...
%     dataparms(23).Files = ["./Data/230425/FOV1.mat", "./Data/230426/FOV1.mat"]; %Where to load data from
    dataparms(23).Files = ["./Data/230428/FOV1.mat", "./Data/230429/FOV1.mat"]; %Where to load data from
...
%     dataparms(24).Files = ["./Data/230504/FOV1.mat", "./Data/230504/FOV2.mat","./Data/230505/FOV1.mat", "./Data/230505/FOV2.mat" ]; %Where to load data from
    dataparms(24).Files = ["./Data/230504/FOV1.mat", "./Data/230505/FOV1.mat"]; %Where to load data from
    ...
    dataparms(25).Files = ["./Data/230509/FOV1.mat", "./Data/230510/FOV1.mat","./Data/230510/FOV2.mat"]; %Where to load data from
%     dataparms(25).Files = ["./Data/230509/FOV1.mat", "./Data/230510/FOV1.mat"]; %Where to load data from
...
%     dataparms(26).Files = ["./Data/230523/FOV1.mat", "./Data/230523/FOV2.mat","./Data/230524/FOV1.mat", "./Data/230524/FOV2.mat"]; %Where to load data from
    dataparms(26).Files = ["./Data/230523/FOV1.mat","./Data/230524/FOV1.mat"]; %Where to load data from
    ...
    dataparms(27).Files = ["./Data/230526/FOV1.mat", "./Data/230526/FOV2.mat"]; %Where to load data from
    ...
    dataparms(28).Files = ["./Data/230601/FOV1.mat", "./Data/230602/FOV1.mat"]; %Where to load data from
    ...
    dataparms(29).Files = ["./Data/230605/FOV1.mat", "./Data/230607/FOV1.mat", "./Data/230608/FOV1.mat"]; %Where to load data from
...
%     dataparms(30).Files = ["./Data/230615/FOV1.mat", "./Data/230615/FOV2.mat", "./Data/230620/FOV1.mat"]; %Where to load data from
    dataparms(30).Files = ["./Data/230615/FOV1.mat",  "./Data/230620/FOV1.mat"];
    ...
    dataparms(31).Files = ["./Data/230621/FOV1.mat", "./Data/230623/FOV1.mat"]; %Where to load data from
    ...
    dataparms(32).Files = ["./Data/230627/FOV1.mat", "./Data/230627/FOV2.mat", "./Data/230628/FOV1.mat"]; %Where to load data from
    ...
    dataparms(33).Files = ["./Data/230629/FOV1.mat", "./Data/230704/FOV1.mat"]; %Where to load data from
...
%     dataparms(34).backConc = 0.01;
    ...
    dataparms(34).Files = ["./Data/230706/FOV1.mat", "./Data/230707/FOV1.mat"]; %Where to load data from
...
%     dataparms(34).concLevels = [0.03, 0.06, 0.11, 0.21, 0.41; 0.03, 0.06, 0.11, 0.21, 0.41];
    ...
    dataparms(35).Files = ["./Data/230710/FOV1.mat"]; %Where to load data from
    ...
    dataparms(36).Files = ["./Data/230711/FOV1.mat"]; %Where to load data from
    ...
    dataparms(37).Files = ["./Data/230714/FOV1.mat", "./Data/230715/FOV1.mat"]; %Where to load data from
...
%     dataparms(38).Files = ["./Data/230815/FOV1.mat", "./Data/230815/FOV2.mat",...
%         "./Data/230816/FOV1.mat", "./Data/230816/FOV2.mat"]; %Where to load data from
    dataparms(38).Files = ["./Data/230815/FOV1.mat", "./Data/230815/FOV2.mat"]; %Where to load data from
    ...
    dataparms(39).Files = ["./Data/230822/FOV1.mat", "./Data/230823/FOV1.mat", "./Data/230823/FOV2.mat"]; %Where to load data from
...
%     dataparms(39).Normp0 = [log(10), log(2), 1];
    ...
    dataparms(40).Files = ["./Data/231017/FOV1.mat", "./Data/231017/FOV2.mat", "./Data/231018/FOV1.mat", "./Data/231018/FOV2.mat"]; %Where to load data from
%     dataparms(40).Files = ["./Data/231017/FOV1.mat", "./Data/231017/FOV2.mat", "./Data/231018/FOV1.mat"]; %Where to load data from
...
%     dataparms(35).concLevels = [0.02, 0.05, 0.1, 0.2, 0.4; 0.02, 0.05, 0.1, 0.2, 0.4];
    ...
    dataparms(41).Files = ["./Data/231207/FOV1.mat", "./Data/231207/FOV2.mat", "./Data/231212/FOV1.mat", "./Data/231212/FOV2.mat"]; %Where to load data from
%     dataparms(41).Files = ["./Data/231212/FOV1.mat", "./Data/231212/FOV2.mat"]; %Where to load data from
...
%     dataparms(42).Files = ["./Data/210610/FOV1.mat", "./Data/210610/FOV2.mat"]; %Where to load data from
    dataparms(42).Files = ["./Data/240131/FOV1.mat", "./Data/240131/FOV2.mat", "./Data/240201/FOV1.mat", "./Data/240201/FOV2.mat"];
...
%     dataparms(42).concLevels = [0.0316, 0.1, 0.316, 1, 1.316; 0.0316, 0.1, 0.316, 1, 1.316];
    ...
    dataparms(43).Files = ["./Data/210616/FOV1.mat", "./Data/210616/FOV2.mat", "./Data/240202/FOV1.mat", "./Data/240202/FOV2.mat"]; %Where to load data from
...
%     dataparms(44).Files = ["./Data/240129/FOV1.mat", "./Data/240129/FOV2.mat", "./Data/240130/FOV1.mat", "./Data/240130/FOV2.mat"]; %Where to load data from
    dataparms(44).Files = ["./Data/240129/FOV1.mat", "./Data/240129/FOV2.mat", "./Data/240130/FOV1.mat"]; %Where to load data from
    ...
    dataparms(45).Files = ["./Data/240229/FOV1.mat", "./Data/240229/FOV1.mat"];
